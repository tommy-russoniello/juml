...
public class Generalization extends Relationship {
	...
	public Generalization(Scanner input, Vector<UMLNode> allNodes, Controller controller) {
	 ...
	 * 
	 * @postcondition Generalization instance with given starting and stopping
	 * UMLNodes is created.
	 */
	...
	public void reset() {
		super.reset();
		shape.getPoints().addAll(new Double[] { endLine.getEndX() - .5, endLine.getEndY(), endLine.getEndX() - 13.125,
				endLine.getEndY() - 7.5, endLine.getEndX() - 13.125, endLine.getEndY() + 7.5 });
	}
